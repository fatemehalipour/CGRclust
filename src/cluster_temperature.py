...
if __name__ == "__main__":
    ...
    for temp_ins in li:
        ...
        result_ins_soft = []
        for temp_clu in li:
            print(f"Temp ins: {temp_ins} | temp clu: {temp_clu}")
            y_preds = []
            y_probs = []
            ...
            print(w)
            result_ins_hard.append(np.sum(np.diag(w) / np.sum(w)))
            ...
            print("Confusion matrix:")
            print(w)
            result_ins_soft.append(np.sum(np.diag(w) / np.sum(w)))
        result_hard.append(result_ins_hard)
        result_soft.append(result_ins_soft)
    print(result_hard)
    print(result_soft)
